...
import com.example.userservice.configs.FirebaseStorageProperties;
...
//    private final FileStorageService fileStorageService;
    ...
    @Override
    public BlogResponse updateBlog(Long id, BlogRequest blogRequest, MultipartFile imageFile) throws IOException {
...
//            blog.setImageTitle(fileStorageService.storeBlogImageFile(imageFile));
            firebaseService.delete(blog.getImageTitle());
            blog.setImageTitle(firebaseService.upload(imageFile, firebaseStorageProperties.getUploadBlogImage()));
        }
    ...
    @Override
    public BlogResponse addBlog(BlogRequest blogRequest, MultipartFile imageFile) throws IOException {
